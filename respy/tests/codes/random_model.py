...
def generate_random_model(
    ...
    file_path : str
        ...
        automatically.
    deterministic : bool
        Indicator for a deterministic model without shocks.
    myopic : bool
        Indicator for myopic agents whose discount factor is zero.
    ...
    params["fixed"] = choice([True, False], size=len(params), p=[0.1, 0.9])
